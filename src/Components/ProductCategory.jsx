...
const ProductCategory = () => {
  ...
  const filteredInstrumentos = state.instrumentos2.filter(
    (instrumento) => selectedCheckboxes.some(val => val.split(',').includes(String(instrumento.id)))
  );
  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.checkboxes}>
        <label style={selectedCheckboxes.includes('1,4,5') ? { backgroundColor: '#6284AB' } : checkboxStyle}>
          <input type="checkbox" value="1,4,5" 
          onChange={handleCheckboxChange} />
          Guitarras
        </label>

        <label style={selectedCheckboxes.includes('9,8') ? { backgroundColor: '#6284AB' } : checkboxStyle}>
          <input
            type="checkbox"
            value="9,8"
            onChange={handleCheckboxChange}
        ...
        <label style={selectedCheckboxes.includes('2') ? { backgroundColor: '#6284AB' } : checkboxStyle}>
          <input
            type="checkbox"
            value="2"
            onChange={handleCheckboxChange}
        ...
        <label style={selectedCheckboxes.includes('3') ? { backgroundColor: '#6284AB' } : checkboxStyle}>
          <input
            type="checkbox"
            value="3"
            onChange={handleCheckboxChange}
        ...
        <label style={selectedCheckboxes.includes('6,7') ? { backgroundColor: '#6284AB' } : checkboxStyle}>
          <input
            type="checkbox"
            value="6,7"
            onChange={handleCheckboxChange}
